        ...
        <>
            {role === 'system' && (<div className="py-2">
                <div className="flex items-start gap-2.5">
                    <img className="w-10 h-10 rounded-full" src="https://cdn-icons-png.flaticon.com/512/3276/3276535.png" alt="image" />
                    <div className="flex flex-col gap-1 w-full max-w-[320px]">
                        <div className="flex items-center space-x-2 rtl:space-x-reverse">
                            <span className="text-sm font-semibold text-gray-900 dark:text-white">System</span>
                            <span className="text-sm font-normal text-gray-500 dark:text-gray-400">speaking...</span>
                        </div>
