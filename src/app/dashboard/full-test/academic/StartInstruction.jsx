      ...
      <div className="max-w-lg w-full bg-white dark:bg-slate-700 shadow-2xl overflow-hidden m-4">
        ...
        <div className="p-8 space-y-6">
          <p className="text-gray-700 dark:text-gray-300 text-lg">
            Welcome to the SpeedyIELTS Full Test! Please read the following instructions
            carefully:
          </p>
          <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 text-sm">
            <li>You have about 2 hour and 45 minutes to complete the test.</li>
            <li>
              The test consists of 4 skills test.
            </li>
            <li>
