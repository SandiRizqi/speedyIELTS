    ...
    <div className="flex flex-1 w-screen h-screen items-center justify-center">
      ...
      <div className="border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark h-screen w-full">
        <div className="flex flex-wrap items-center h-full">
          ...
          <img
            src="/images/SHUTTERSTOCK_2180414785_2500.png"
            alt="Background"
            className="object-cover w-full h-screen"
          />
          </div>

          <div className="flex w-full justify-center border-stroke dark:border-strokedark xl:w-1/3">
            <div className="max-w-screen-md  p-4 sm:p-12.5 xl:p-8 shadow-xl rounded-xl">
              ...
              <form>
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value="Sign In"
                    className="w-full cursor-pointer rounded-lg border border-blue-600 bg-blue-600 p-2 text-white transition hover:bg-opacity-90"
                  />
                </div>

                </form>

                <button className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-2 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50" onClick={handleSignInGoogle}>
                  <span>
                    <svg
                      width="20"
                      height="20"
