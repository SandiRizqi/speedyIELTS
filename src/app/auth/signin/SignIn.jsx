          ...
          <div className="flex w-full justify-center border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="max-w-screen-md  p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <button className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50" onClick={handleSignInGoogle}>
                  <span>
                    <svg
                      width="20"
                      height="20"
